  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          // Fixed app bar with search bar and sport filter titles
          SliverAppBar(
            expandedHeight: 120, // Allow space for the sport filter titles
                          ...
                          return Container(
                            ...
                            child: GestureDetector(
                              ...
                              child: Column(
                                ...
                                children: [
                                  // Only show the title text in the fixed header
                                  Text(
                                    sport,
                                    style: TextStyle(
                                      fontSize: 12,
          ...
          // Sports Filter Icons (separate from titles) - these will hide on scroll
          SliverToBoxAdapter(
            child: AnimatedBuilder(
              animation: _animationController,
              builder: (context, child) {
                // Hide this section completely when scrolled enough
