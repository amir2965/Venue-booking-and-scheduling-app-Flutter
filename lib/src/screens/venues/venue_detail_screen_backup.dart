...
class _VenueDetailScreenState extends ConsumerState<VenueDetailScreen> {
  ...
  Widget _buildVenueDetail(BuildContext context, Venue venue) {
    ...
    return Stack(
      children: [
        // Scrollable content area that can move up over the image
        CustomScrollView(
          slivers: [
            SliverPadding(
        ...
        // Image counter overlay (cleaned up, removed zoom hint that was causing the black element)
        Positioned(
        ...
        // Background image carousel positioned to be interactive
        Positioned(
          top: 0,
          left: 0,
          right: 0,
